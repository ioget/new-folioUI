<template>
  <div class="relative">
    <div class="bg-background border-gradient rounded-xl p-4">
      <div class="aspect-w-16 aspect-h-9 rounded-lg relative overflow-hidden border border-dashed border-gray-700 dark:border-white/10">
        <img src="/did-1.png" alt="" srcset="">
      </div>
    </div>
  </div>
</template>
